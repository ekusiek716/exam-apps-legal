...
資格試験トレーニングアプリ群（電工2種トレ／電工1種トレ／応用情報トレ／ITパスポートトレ／基本情報トレ／HCD基礎検定トレ／社労士トレ）の
...
7アプリ共通の1ページ構成です（各ページ末尾の「対象アプリ」節で対象を列挙）。HCD基礎検定トレと社労士トレはオリジナル問題を収録し、他5アプリは公開過去問を出典とします。
